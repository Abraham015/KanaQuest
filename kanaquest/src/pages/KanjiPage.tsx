        ...
        return (
            <main className="page-container">
                ...
                <section className="auth-required-panel">
                    ...
                    <p>
                        {isConfigured
                            ? "Las carpetas de kanji solo se muestran con una cuenta iniciada o creada. Si pierdes conexion despues de iniciar sesion, las tarjetas nuevas se guardan localmente."
                            : "Supabase no esta configurado. Configuralo para crear o iniciar una cuenta antes de usar carpetas de kanji."}
                    </p>
                </section>
            </main>
        );
